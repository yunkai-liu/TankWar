...
public class Missile 
{
	...
	public Missile(int tankID, int x, int y, Direction direction) 
	{
		this.tankID = tankID;
		this.x = x;
		this.y = y;
		...
		this.missileID = init_id++;
	}
	
	public Missile(int tankID, int x, int y, boolean good, Direction direction, TankClient tc) 
	{
