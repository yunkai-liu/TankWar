...
public class Tank 
{
	...
	public Tank(int x, int y, boolean good)
	{
		...
		this.step = random.nextInt(Constant.RANDOM_NUMBER_ONE) +  Constant.RANDOM_NUMBER_TWO;
	}
	...
	public void move()
	{
		...
		if(!good)
		{
			if(step == 0)
			{
				step = random.nextInt(Constant.RANDOM_NUMBER_ONE) +  Constant.RANDOM_NUMBER_TWO;
			...
			if(random.nextInt(Constant.RANDOM_FIRE_ONE) > Constant.RANDOM_FIRE_TWO)
			{
				fire();
			}
		}
	...
	public void fire()
	{
		...
		Missile m = new Missile(mx, my, good, shotDirection, tc);
	...
	public void fire(Direction d)
	{
		...
		Missile m = new Missile(mx, my, good, d, tc);
		tc.getMissiles().add(m);
	}
